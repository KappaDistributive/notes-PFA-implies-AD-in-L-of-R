...
$\Sigma_1$-gap iff
      \begin{enumerate}
    \item $J_{\alpha}(\mathbb{R}) \prec_1^{\mathcal{L}(\mathbb{R} \cup
\{ V_{\omega + 1} \})} J_{\beta}(\mathbb{R})$,
    \item $\forall \alpha' < \alpha \colon J_{\alpha'}(\mathbb{R})
\not \prec_1^{\mathcal{L}(\mathbb{R} \cup \{ V_{\omega + 1} \})}
J_{\alpha}(\mathbb{R})$ and
    \item $\forall \beta' > \beta J_{\beta}(\mathbb{R}) \not
\prec_1^{\mathcal{L}(\mathbb{R} \cup \{ V_{\omega + 1} \})}
J_{\beta'}(\mathbb{R})$.
    \end{enumerate}
